  ...
  >
      ...
      >
        ...
        >
          <el-input
            ...
            data-testid="eventsCreateDialogFormInputTitle"
          />
        </el-form-item>
        ...
        >
          <el-date-picker
            ...
            data-testid="eventsCreateDialogFormDatePickerDates"
          />
        </el-form-item>
        ...
        >
          <el-select
            ...
            data-testid="eventsCreateDialogFormSelectCategory"
          >
            <el-option
              ...
              :label="category.name"
              :value="category.id"
              :data-testid="`eventsCreateDialogFormSelectCategoryValue${category.name.replace(/\s/g, '')}`"
            />
          </el-select>
        </el-form-item>
    ...
    <template slot="footer">
      ...
      <el-button
        class="block"
        type="primary"
        data-testid="eventsCreateDialogFormButtonSubmit"
        @click="submit"
      >
        {{ $t("save") }}
      </el-button>
