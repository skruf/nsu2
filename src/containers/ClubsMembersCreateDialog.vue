  ...
  >
      ...
      >
        ...
        >
          <el-input
            ...
            data-testid="clubsMembersCreateDialogFormInputFirstName"
        ...
        >
          <el-input
            ...
            data-testid="clubsMembersCreateDialogFormInputLastName"
        ...
        >
          <el-input
            ...
            data-testid="clubsMembersCreateDialogFormInputEmailAddress"
    ...
    <template slot="footer">
      ...
      <el-button
        class="block"
        type="primary"
        data-testid="clubsMembersCreateDialogFormButtonSubmit"
        @click="submit"
      >
        {{ $t("save") }}
      </el-button>
