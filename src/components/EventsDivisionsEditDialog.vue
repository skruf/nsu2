<i18n>
{
  "en": {
    ...
    "eventsDivisionsActionsEditOneSuccess": "%{divisionName} was successfully updated in the database"
  },
  "no": {
    "dialogTitle": "Rediger standplassliste",
    "eventsDivisionsActionsEditOneSuccess": "%{divisionName} ble redigert i databasen"
  }
}
</i18n>
