...
describe("events.view.results", () => {
  beforeEach(() => {
    ...
    cy.startup()
    cy.wait(5000)
    cy.getById("eventsViewScreenTabsResultsTab").click()
  })

  it("Group by", () => {
    cy.getById("eventsContestantsResultsTableGroupByWeaponButton").click()
    cy.getById("eventsContestantsResultsTableGroupByWeaponTd")
      .should("be.visible")
    cy.getById("eventsContestantsResultsTableGroupByNoneButton").click()
    cy.getById("eventsContestantsResultsTableGroupByWeaponTd")
      .should("not.be.visible")
  })

  it("Set results", () => {
    cy.getById("eventsContestantsResultsInputDialogOpen").first().click()
    ...
    cy.getById("eventsContestantsResultsInputDialogSubmit").click()
    cy.getById("eventsContestantsResultsListTable").contains("60")
  })
})
